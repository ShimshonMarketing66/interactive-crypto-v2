...
export class ChartUI implements AfterViewChecked {
  ...
  PeriodSelected: string = "1 Hour"
  TypeSelected: string = "candle"
  ...
  onSelectPeriod() {
    for (let index = 0; index < this.periodicityOptions.length; index++) {
  ...
  onSelectType() {
    for (let index = 0; index < this.chartTypes.length; index++) {
